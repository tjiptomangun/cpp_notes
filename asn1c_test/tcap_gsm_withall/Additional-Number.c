...
static const asn_TYPE_tag2member_t asn_MAP_Additional_Number_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* msc-Number */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* sgsn-Number */
};
