...
static const asn_INTEGER_enum_map_t asn_MAP_SM_DeliveryNotIntended_value2enum_1[] = {
	{ 0,	18,	"onlyIMSI-requested" },
	{ 1,	21,	"onlyMCC-MNC-requested" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_SM_DeliveryNotIntended_enum2value_1[] = {
	0,	/* onlyIMSI-requested(0) */
	1	/* onlyMCC-MNC-requested(1) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_SM_DeliveryNotIntended_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_SM_DeliveryNotIntended_tags_1[] = {
