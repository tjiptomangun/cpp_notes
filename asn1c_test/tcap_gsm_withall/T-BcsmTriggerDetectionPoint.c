...
static const asn_INTEGER_enum_map_t asn_MAP_T_BcsmTriggerDetectionPoint_value2enum_1[] = {
	{ 12,	21,	"termAttemptAuthorized" },
	{ 13,	5,	"tBusy" },
	{ 14,	9,	"tNoAnswer" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_T_BcsmTriggerDetectionPoint_enum2value_1[] = {
	1,	/* tBusy(13) */
	2,	/* tNoAnswer(14) */
	0	/* termAttemptAuthorized(12) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_T_BcsmTriggerDetectionPoint_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_T_BcsmTriggerDetectionPoint_tags_1[] = {
