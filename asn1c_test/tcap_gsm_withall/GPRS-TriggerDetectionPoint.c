...
static const asn_INTEGER_enum_map_t asn_MAP_GPRS_TriggerDetectionPoint_value2enum_1[] = {
	{ 1,	6,	"attach" },
...
static const unsigned int asn_MAP_GPRS_TriggerDetectionPoint_enum2value_1[] = {
	0,	/* attach(1) */
...
static const asn_INTEGER_specifics_t asn_SPC_GPRS_TriggerDetectionPoint_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_GPRS_TriggerDetectionPoint_tags_1[] = {
