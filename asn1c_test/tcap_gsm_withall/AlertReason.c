...
static const asn_INTEGER_enum_map_t asn_MAP_AlertReason_value2enum_1[] = {
	{ 0,	10,	"ms-Present" },
	{ 1,	15,	"memoryAvailable" }
};
static const unsigned int asn_MAP_AlertReason_enum2value_1[] = {
	1,	/* memoryAvailable(1) */
	0	/* ms-Present(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_AlertReason_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_AlertReason_tags_1[] = {
