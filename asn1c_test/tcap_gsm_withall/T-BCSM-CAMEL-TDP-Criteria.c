...
static const ber_tlv_tag_t asn_DEF_T_BCSM_CAMEL_TDP_Criteria_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_T_BCSM_CAMEL_TDP_Criteria_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 0, 0, 0 }, /* t-BCSM-TriggerDetectionPoint */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* basicServiceCriteria */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 } /* t-CauseValueCriteria */
};
