...
static asn_TYPE_member_t asn_MBR_resultretres_3[] = {
	...
	{ ATF_OPEN_TYPE | ATF_POINTER, 1, offsetof(struct resultretres, returnparameter),
		-1 /* Ambiguous tag (ANY?) */,
		0,
...
static const ber_tlv_tag_t asn_DEF_resultretres_tags_3[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_resultretres_tag2el_3[] = {
