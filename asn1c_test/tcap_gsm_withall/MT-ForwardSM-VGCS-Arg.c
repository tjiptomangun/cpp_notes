...
static const ber_tlv_tag_t asn_DEF_MT_ForwardSM_VGCS_Arg_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MT_ForwardSM_VGCS_Arg_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 0, 0, 1 }, /* asciCallReference */
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 2, -1, 0 }, /* sm-RP-UI */
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 1, 0, 0 } /* noSM-RP-OA */
};
