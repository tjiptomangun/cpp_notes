...
static const asn_INTEGER_enum_map_t asn_MAP_SM_DeliveryOutcome_value2enum_1[] = {
	{ 0,	22,	"memoryCapacityExceeded" },
	{ 1,	16,	"absentSubscriber" },
	{ 2,	18,	"successfulTransfer" }
};
static const unsigned int asn_MAP_SM_DeliveryOutcome_enum2value_1[] = {
	1,	/* absentSubscriber(1) */
	0,	/* memoryCapacityExceeded(0) */
	2	/* successfulTransfer(2) */
};
static const asn_INTEGER_specifics_t asn_SPC_SM_DeliveryOutcome_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_SM_DeliveryOutcome_tags_1[] = {
