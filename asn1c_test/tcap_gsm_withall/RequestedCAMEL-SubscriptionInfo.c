...
static const asn_INTEGER_enum_map_t asn_MAP_RequestedCAMEL_SubscriptionInfo_value2enum_1[] = {
	{ 0,	5,	"o-CSI" },
	{ 1,	5,	"t-CSI" },
	{ 2,	6,	"vt-CSI" },
	{ 3,	7,	"tif-CSI" },
...
static const unsigned int asn_MAP_RequestedCAMEL_SubscriptionInfo_enum2value_1[] = {
	8,	/* d-csi(8) */
	4,	/* gprs-CSI(4) */
	7,	/* m-CSI(7) */
	5,	/* mo-sms-CSI(5) */
...
static const asn_INTEGER_specifics_t asn_SPC_RequestedCAMEL_SubscriptionInfo_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_RequestedCAMEL_SubscriptionInfo_tags_1[] = {
