...
static const asn_INTEGER_enum_map_t asn_MAP_GuidanceInfo_value2enum_1[] = {
	{ 0,	7,	"enterPW" },
	{ 1,	10,	"enterNewPW" },
	{ 2,	16,	"enterNewPW-Again" }
};
static const unsigned int asn_MAP_GuidanceInfo_enum2value_1[] = {
	1,	/* enterNewPW(1) */
	2,	/* enterNewPW-Again(2) */
	0	/* enterPW(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_GuidanceInfo_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_GuidanceInfo_tags_1[] = {
