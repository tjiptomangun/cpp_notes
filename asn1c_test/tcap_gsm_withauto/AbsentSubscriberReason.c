...
static const asn_INTEGER_enum_map_t asn_MAP_AbsentSubscriberReason_value2enum_1[] = {
	{ 0,	10,	"imsiDetach" },
	{ 1,	14,	"restrictedArea" },
	{ 2,	14,	"noPageResponse" },
	{ 3,	8,	"purgedMS" }
...
static const unsigned int asn_MAP_AbsentSubscriberReason_enum2value_1[] = {
	0,	/* imsiDetach(0) */
	2,	/* noPageResponse(2) */
	3,	/* purgedMS(3) */
	1	/* restrictedArea(1) */
...
static const asn_INTEGER_specifics_t asn_SPC_AbsentSubscriberReason_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_AbsentSubscriberReason_tags_1[] = {
