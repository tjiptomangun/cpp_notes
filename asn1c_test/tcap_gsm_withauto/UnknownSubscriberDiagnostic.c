...
static const asn_INTEGER_enum_map_t asn_MAP_UnknownSubscriberDiagnostic_value2enum_1[] = {
	{ 0,	11,	"imsiUnknown" },
	{ 1,	28,	"gprs-eps-SubscriptionUnknown" },
	{ 2,	12,	"npdbMismatch" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_UnknownSubscriberDiagnostic_enum2value_1[] = {
	1,	/* gprs-eps-SubscriptionUnknown(1) */
	0,	/* imsiUnknown(0) */
	2	/* npdbMismatch(2) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_UnknownSubscriberDiagnostic_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_UnknownSubscriberDiagnostic_tags_1[] = {
