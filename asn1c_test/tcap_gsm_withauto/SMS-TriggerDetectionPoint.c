...
static const asn_INTEGER_enum_map_t asn_MAP_SMS_TriggerDetectionPoint_value2enum_1[] = {
	{ 1,	17,	"sms-CollectedInfo" },
	{ 2,	19,	"sms-DeliveryRequest" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_SMS_TriggerDetectionPoint_enum2value_1[] = {
	0,	/* sms-CollectedInfo(1) */
	1	/* sms-DeliveryRequest(2) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_SMS_TriggerDetectionPoint_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_SMS_TriggerDetectionPoint_tags_1[] = {
