...
static const asn_INTEGER_enum_map_t asn_MAP_ForwardingReason_value2enum_1[] = {
	{ 0,	12,	"notReachable" },
	{ 1,	4,	"busy" },
	{ 2,	7,	"noReply" }
};
static const unsigned int asn_MAP_ForwardingReason_enum2value_1[] = {
	1,	/* busy(1) */
	2,	/* noReply(2) */
	0	/* notReachable(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_ForwardingReason_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_ForwardingReason_tags_1[] = {
