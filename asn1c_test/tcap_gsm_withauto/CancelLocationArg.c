...
static asn_TYPE_member_t asn_MBR_CancelLocationArg_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct CancelLocationArg, cancellationType),
	...
	{ ATF_POINTER, 2, offsetof(struct CancelLocationArg, extensionContainer),
	...
	{ ATF_POINTER, 1, offsetof(struct CancelLocationArg, typeOfUpdate),
...
static const ber_tlv_tag_t asn_DEF_CancelLocationArg_tags_1[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CancelLocationArg_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 0, 0, 0 }, /* imsi */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 1, 0, 0 }, /* cancellationType */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 1 }, /* imsi-WithLMSI */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -1, 0 }, /* extensionContainer */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 3, 0, 0 } /* typeOfUpdate */
};
