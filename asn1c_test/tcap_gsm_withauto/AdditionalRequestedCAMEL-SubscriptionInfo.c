...
static const asn_INTEGER_enum_map_t asn_MAP_AdditionalRequestedCAMEL_SubscriptionInfo_value2enum_1[] = {
	{ 0,	10,	"mt-sms-CSI" },
	{ 1,	6,	"mg-csi" },
	{ 2,	8,	"o-IM-CSI" },
	{ 3,	8,	"d-IM-CSI" },
...
static const unsigned int asn_MAP_AdditionalRequestedCAMEL_SubscriptionInfo_enum2value_1[] = {
	3,	/* d-IM-CSI(3) */
	1,	/* mg-csi(1) */
	0,	/* mt-sms-CSI(0) */
	2,	/* o-IM-CSI(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_AdditionalRequestedCAMEL_SubscriptionInfo_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_AdditionalRequestedCAMEL_SubscriptionInfo_tags_1[] = {
