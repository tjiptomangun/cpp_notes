 ...
 * this only used to get handle_* and copy the result to int/nstAgentModules.c
 */
...
/** Initializes the nstAgentModules module */
void
init_nstAgentModules(void)
{
  ...
  DEBUGMSGTL(("nstAgentModules", "Initializing\n"));

    netsnmp_register_scalar(
        netsnmp_create_handler_registration("nstAgentModuleObject", handle_nstAgentModuleObject,
                               nstAgentModuleObject_oid, OID_LENGTH(nstAgentModuleObject_oid),
                               HANDLER_CAN_RWRITE
        ));
    netsnmp_register_scalar(
        netsnmp_create_handler_registration("nstAgentSubagentObject", handle_nstAgentSubagentObject,
                               nstAgentSubagentObject_oid, OID_LENGTH(nstAgentSubagentObject_oid),
                               HANDLER_CAN_RWRITE
        ));
    netsnmp_register_scalar(
        netsnmp_create_handler_registration("nstAgentPluginObject", handle_nstAgentPluginObject,
