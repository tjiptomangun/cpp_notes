 ...
 */
    ...
    if ((NULL == (* ifDescr_val_ptr_ptr )) ||
        ...
        if(NULL == (* ifDescr_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory (rowreq_ctx->data.ifDescr)\n");
            return MFD_ERROR;
        }
    }
 ...
 */
    ...
    if ((NULL == (* ifPhysAddress_val_ptr_ptr )) ||
        ...
        if(NULL == (* ifPhysAddress_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory (rowreq_ctx->data.ifPhysAddress)\n");
            return MFD_ERROR;
        }
    }
 ...
 */
    ...
    if ((NULL == (* ifSpecific_val_ptr_ptr )) ||
        ...
        if(NULL == (* ifSpecific_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory (rowreq_ctx->data.ifSpecific)\n");
            return MFD_ERROR;
        }
    }
