...
------------------------------------------------------------------------
  ...
  the ciscoLS1010ModuleTable table.  The agent will start by looking for the right
  ...
  file defaults/table-ciscoLS1010ModuleTable.m2d, and then re-running mib2c.
    ...
    in the ciscoLS1010ModuleTable.h header.
 ...
 Index(es) for the ciscoLS1010ModuleTable table
  ------------------------------------------------------------
  The index(es) for the ciscoLS1010ModuleTable table are:
...
************************************************************************
ciscoLS1010ModuleTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the ciscoLS1010ModuleTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: ciscoLS1010ModuleTable_data_access.[c|h]
------------------------------------------------------------------------
  The ciscoLS1010ModuleTable_data_access file contains the interface to your data in
  ...
  FUNC : ciscoLS1010ModuleTable_indexes_set
  WHERE: ciscoLS1010ModuleTable_data_access.c
...
File: ciscoLS1010ModuleTable_enums.h
------------------------------------------------------------------------
...
File: ciscoLS1010ModuleTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleType_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleSerialNumber_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleHwVersion_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleSwVersion_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleDescr_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleNumSubModules_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleAdminStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleOperStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleHwVersionMinor_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ciscoLS1010ModuleSerialNumberString_get



File: ciscoLS1010ModuleTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-ciscoLS1010ModuleTable.m2d
  ...
  FUNC : ciscoLS1010ModuleTable_undo_setup
  ...
  FUNC : ciscoLS1010ModuleAdminStatus_check_value
  ...
  FUNC : ciscoLS1010ModuleAdminStatus_undo_setup
  ...
  FUNC : ciscoLS1010ModuleAdminStatus_set
  ...
  FUNC : ciscoLS1010ModuleAdminStatus_undo
  ...
  --------------
  TODO : commit changes
  FUNC : ciscoLS1010ModuleTable_commit
...
************************************************************************
ciscoLS1010ModuleTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      ciscoLS1010ModuleTable table.

      Conversely, the examples below may not include some functions that
      were generated for the ciscoLS1010ModuleTable table.

To watch the flow of the ciscoLS1010ModuleTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        ciscoLS1010ModuleTable
        verbose:ciscoLS1010ModuleTable
        internal:ciscoLS1010ModuleTable

e.g.
        snmpd -f -Le -DciscoLS1010ModuleTable,verbose:ciscoLS1010ModuleTable,internal:ciscoLS1010ModuleTable
...
/*---------------------------------------------------------------------
 * CISCO-RHINO-MIB::ciscoLS1010ModuleEntry.ciscoLS1010ModuleIndex
 * ciscoLS1010ModuleIndex is subid 1 of ciscoLS1010ModuleEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.9.5.11.1.2.1.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE ciscoLS1010ModuleIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
