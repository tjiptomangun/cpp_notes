...
begin with the ciscoLS1010ModuleTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : ciscoLS1010ModuleTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f ciscoLS1010ModuleTable_Makefile


  File    : ciscoLS1010ModuleTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   ciscoLS1010ModuleTable-README-ciscoLS1010ModuleTable.txt
...
------------------------------------------------------------------------
  ...
  File    : ciscoLS1010ModuleTable_interface.c
