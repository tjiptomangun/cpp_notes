...
static void usage(void) {
   printf("usage: nstAgentModuleObject [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLM-:x:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("nstAgentModuleObject");        /* register our .conf handlers */
      init_nstAgentModuleObject();  
      init_snmp("nstAgentModuleObject");
  ...
  init_agent("nstAgentModuleObject");

  /* init nstAgentModuleObject mib code */
  init_nstAgentModuleObject();  

  /* read nstAgentModuleObject.conf files. */
  init_snmp("nstAgentModuleObject");
  ...
  /* at shutdown time */
  snmp_shutdown("nstAgentModuleObject");
  SOCK_CLEANUP;
  exit(0);
}
