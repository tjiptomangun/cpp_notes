 ...
 */
int ExecSystem(char * process, short nowait)
{
	time_t now;
	struct tm tmnow;
	...
	sprintf (logbuff , "../log/%s", logname);
	sprintf (timeexec, "%02d_%02d_%02d %02d:%02d:%02d", tmnow.tm_year-100, 
