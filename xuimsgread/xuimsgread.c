 ...
 *
 */
int printAlarmMessage(BYTE *inBuffer)
{
	XUI_REPLY	*pXuiRp;
	XUI_SYSRUN_ALARM *pAlarm;

	pXuiRp	=(XUI_REPLY *) inBuffer;
	pAlarm  =(XUI_SYSRUN_ALARM *) (pXuiRp->strObjectData);

	printf("Rp=0x%X  Alarm=0x%X\n", (unsigned int) pXuiRp,
                       (unsigned int) pAlarm);

	printf("SizeOf AllData          = % 4d\n\n", sizeof(XUI_REPLY) - XL_MAX_OBJECT_DATA_SIZE+
				sizeof(XUI_SYSRUN_ALARM));
	printf("AlarmStatus - pReply      = % 4d\n", ((char *)pAlarm - (char *)pXuiRp));
	...
	printf("\nAlarmStatus\n------------\n");
	printf("unPointStatus  = %d\n",pAlarm->unPointStatus);
...
int printXuiNdcMessage(BYTE *inBuffer)
{
	...
	printf("SizeOf AllData          = % 4d\n", sizeof(XUI_REPLY) - XL_MAX_OBJECT_DATA_SIZE +
                                         sizeof(XL_DEV_STATUS) + sizeof(XL_NDC_STATUS));
        

	printf("NdcStatus - pReply      = % 4d\n", ((char *)pXLNdcStatus - (char *)pXuiRp));
	printf("NdcStatus        Offset = % 4d   Size = % 4d\n", (BYTE*) pXLNdcStatus - (BYTE*) pXuiRp, sizeof(XL_NDC_STATUS));
	printf("NdcCtrlCounters  Offset = % 4d   Size = % 4d\n", (BYTE*) &pXLNdcStatus->CentralCounters - (BYTE*)pXuiRp, sizeof(XL_NDC_CENTRAL_COUNTERS));
	printf("NdcHwConfig      Offset = % 4d   Size = % 4d\n", (BYTE*) &pXLNdcStatus->HWConfig - (BYTE*)pXuiRp, sizeof(XL_NDC_HW_CONFIG));
	printf("NdcHwFitness     Offset = % 4d   Size = % 4d\n", (BYTE*) &pXLNdcStatus->HWFitness - (BYTE*)pXuiRp, sizeof(XL_NDC_HW_FITNESS));
	printf("NdcSupplies      Offset = % 4d   Size = % 4d\n", (BYTE*) &pXLNdcStatus->Supplies - (BYTE*)pXuiRp, sizeof(XL_NDC_SUPPLIES));
	printf("NdcSensor        Offset = % 4d   Size = % 4d\n", (BYTE*) &pXLNdcStatus->SensorStatus - (BYTE*)pXuiRp, sizeof(XL_NDC_SENSORS));

	printf("NdcCounters      Offset = % 4d   Size = % 4d\n\n",(BYTE*) &pXLNdcStatus->SupplyCounters - (BYTE*)pXuiRp,sizeof(XL_NDC_COUNTERS));
