...
{
	unsigned short	nTimeOfDayClock		:4;		/*		NDC */
	unsigned short	nHighOrderComm		:4;		/*		NDC */
	unsigned short	nSystemDisk			:4;		/*		NDC */
	unsigned short	nFlexDisk			:4;		/*		NDC */
	unsigned short	nCardReader			:4;
	unsigned short	nDispenser			:4;
	unsigned short	nUNUSED				:8;
	unsigned short	nDenomination[XL_ATM_MAX_DENOMINATION_TYPE];	/*		NDC */
	unsigned short	nCassetteSlot[XL_ATM_MAX_CASSETTE_SLOT];		/* DBO		*/
	...
	unsigned short	nStatementPrinter	:4;		/* DBO,	NDC */
	unsigned short	nPassbookPrinter	:4;		/* DBO		*/
	unsigned short	nCamera				:4;		/*		NDC */
	unsigned short	nEncryptor			:4;		/*		NDC */
	unsigned short	nDoorAccess			:4;		/*		NDC */
	unsigned short	nVandalShield		:4;		/* DBO		*/
